...
All code, protocols, and deployment configurations are publicly available as open source, enabling reproduction and extension by the global research community.

**Keywords:** Autonomous AI Agents, Payment Protocols, Game Theory, Social Welfare, Offline Computing, Edge AI

---

## SHORT ABSTRACT (for Google Proposal)

Mulberry's Social-Agentic Commerce framework enables autonomous AI agents to serve vulnerable populations through three innovations: (1) world's first NH Nonghyup-AP2 payment integration achieving sub-200ms latency, (2) PSTN-based offline revocation reducing critical response time by 120x, and (3) game theory market design ensuring legal compliance. Real-world deployment in rural South Korea demonstrates 1,866% ROI with 99.9% reliability, proving autonomous commerce can serve society's most marginalized communities.
...
"We solved autonomous commerce for the 60% of the world that lacks reliable internet. Our Voice Protocol lets AI agents serve elderly populations in food deserts using basic phones and the telephone network, achieving 1,866% ROI while maintaining 99.9% reliability. First deployed in rural South Korea, now ready for global scale."
...
- ✅ Works offline (95% coverage via PSTN)
- ✅ Integrates legacy banking (SOAP APIs)
- ✅ 10x lower cost ($12/mo vs $120/mo)

**vs. Mobile Money Solutions:**

- ✅ No smartphone required (basic phone)
- ✅ No technical literacy barrier
- ✅ Serves elderly/rural populations

**vs. Call Center Welfare:**

- ✅ 24/7 autonomous operation
- ✅ Sub-200ms transaction time
- ✅ Scalable without human operators
...
- First real-world integration with national banking
- Proves AP2 viability beyond developed markets
- Extends AP2 to offline scenarios
...
- Novel offline computing approach
- Game theory applied to AI systems
...
**Scalability:** Ready for 100 → 1,000 → 100,000 users
...
1. Feature Mulberry in AP2 case studies
2. Collaborate on offline protocol standardization
3. Support global deployment (GCP credits)
4. Co-publish research findings

**Next Steps:**

- arXiv submission (March 2026)
- Hugging Face demo deployment
- ACM conference presentation
- International expansion

---

**Contact:**  
Malu (Chief of Staff): malu.helpme@gmail.com  
Project Site: https://mulberry.io  
