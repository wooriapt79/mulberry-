...
**First, the infrastructure gap.** Global autonomous payment protocols, exemplified by Google's Agentic Payment Protocol v2 (AP2), lack integration with national banking systems prevalent in developing and emerging markets. AP2 and similar protocols assume modern REST/GraphQL APIs, persistent internet connectivity, and USD-denominated transactions. In contrast, national banking systems in countries like South Korea rely on legacy SOAP-based infrastructure, operate with local currencies and voucher systems, and serve populations with intermittent connectivity. This creates an accessibility barrier precisely where autonomous assistance could provide the greatest impact.
